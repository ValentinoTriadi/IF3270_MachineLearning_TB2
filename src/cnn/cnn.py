import time
from layers import Conv2DLayer, ReLULayer, MaxPooling2DLayer, FlattenLayer, GlobalAveragePooling2DLayer, AveragePooling2DLayer, DenseLayer, SoftmaxLayer, TanhLayer, SigmoidLayer
